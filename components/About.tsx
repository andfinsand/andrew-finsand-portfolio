...
const AboutMe = () => {
  ...
  return (
    <div className="flex flex-col my-64" id="about">
        ...
        <div data-aos="fade-up" data-aos-mirror="true" className="text-4xl text-center text-white font-bakbakone font-normal mb-10">
          <p>About <span className="text-seagreen">Me</span></p>
        </div>
        <div data-aos="fade-up" data-aos-mirror="true" className = "flex flex-col">
        ...
        <div data-aos="fade-up" data-aos-mirror="true" className="flex justify-center mt-10 mb-10">
