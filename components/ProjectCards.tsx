    ...
    <div className="bg-black bg-auto" id="projects">
        ...
        <ProjectText />
            ...
            <div className="flex justify-around bg-black">
                <div className="greyGradient card w-96 shadow-xl rounded-tr-3xl rounded-bl-3xl rounded-tl-none rounded-br-none">
                    ...
                    <div className="card-body items-left text-left text-white">
                        ...
                        <div className="card-actions justify-center mt-5">
                            <button className="btn btn-primary text-dark font-bold bg-seagreen border-seagreen drop-shadow-customLight hover:bg-dark hover:text-seagreen hover:border-seagreen">Details</button>
                        </div>
                    </div>
                </div>
                {/* Project Two */}
                <div className="greyGradient card w-96 bg-medium shadow-xl border rounded-tr-3xl rounded-bl-3xl rounded-tl-none rounded-br-none">
                    <figure className="drop-shadow-customDark p-5">
